#!/usr/bin/env python3
"""Polars+Pandas混用版Debug脚本 - 修复排序问题"""
import sys
...
def calculate_alpha101_factor_debug(df: pl.DataFrame, debug_dir: str):
    ...
    # 显示部分数据
    sample = result.filter(pl.col("ts_code") == "000001.SZ")
...
def main():
    ...
    START_DATE = "20240101"
    END_DATE = "20240131"
    DEBUG_DIR = "/home/quan/testdata/aspipe_v4/debug_mixed_fixed"
