"""Configuration dataclasses for the 24H orchestration center."""
# ruff: noqa: D101, D102
...
class MiningConfig:
    ...
    resource_governor: GovernorConfig = field(default_factory=GovernorConfig)
    ...
    def from_dict(cls, d: dict) -> "MiningConfig":
        ...
        return cls(
            ...
            resource_governor=GovernorConfig.from_dict(d.get("resource_governor", {})),
        )
...
class PipelineConfig:
    ...
    def _from_dict(cls, data: dict | None) -> "PipelineConfig":
        ...
        return cls(
            ...
            training=training,
            llm=llm,
            continuous_lock_dir=str(data.get("continuous_lock_dir", "log/continuous/locks")),
        )
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "mining": {
                ...
                "resource_governor": self.mining.resource_governor.to_dict(),
                "escalation": {
