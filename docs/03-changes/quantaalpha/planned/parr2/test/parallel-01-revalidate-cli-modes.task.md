...
# Test Task: Revalidate CLI Modes

先阅读：

- 同名 `dev` 阶段 task 文档
- `/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/planned/parr2/dev/batch.status.json`
- `/home/quan/testdata/aspipe_v4/auto/tasks/task-*-parallel-01-revalidate-cli-modes/runs/run-*/summary.md`
- `/home/quan/testdata/aspipe_v4/auto/tasks/task-*-parallel-01-revalidate-cli-modes/runs/run-*/*.result.md`
- `/home/quan/testdata/aspipe_v4/auto/tasks/task-*-parallel-01-revalidate-cli-modes/runs/run-*/status.json`
