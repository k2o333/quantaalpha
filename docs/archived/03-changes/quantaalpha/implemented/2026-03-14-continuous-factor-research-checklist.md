...
这批文档最初是设计清单，不再代表“待做事项”。截至当前代码状态：
...
1. [统一股票池过滤入口](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-unified-stock-universe-filter.md)
2. [多周期验证](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-multi-period-validation.md)
3. [因子库状态与验证字段扩展](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-factor-library-schema-extension.md)
4. [最小版数据能力注册表](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/archived/2026-03-14-data-capability-registry.md)

### Phase 2

1. [手动 Revalidate CLI](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-revalidate-cli.md)
2. [因子状态流转规则](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-factor-status-transition-rules.md)
3. [多周期稳定性结果接入 Evolution](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-stability-results-in-evolution.md)
4. [任务级 LLM 路由](/home/quan/testdata/aspipe_v4/docs/03-changes/quantaalpha/implemented/2026-03-14-task-level-llm-routing.md)
...
- 本目录现在是“设计 + 实际落地回填”混合索引，不能再当成纯待办列表。
- 每份文档里的 `Final Result`、`Validation Evidence`、`Lessons Learned` 已按当前代码状态回填。
- 如后续代码继续演进，应继续维护这些 change docs，而不是新建一套平行清单。
