...
pagination:
  enabled: true
  mode: "date_range"
  date_parameter_type: "announcement"
```
...
效果：获取公告日期在 20230401-20230630 范围内的数据
...
命令行：
```bash
python app4/main.py --start_date 20230401 --end_date 20231231 --interface income_vip
```

效果：获取报告期为 20230331、20230630、20230930、20231231 的数据
