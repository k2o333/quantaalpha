...
# 测试 Type B 接口的增量下载功能
# Type B 接口：报告期接口（支持范围查询）
# 每次下载前清空数据，第一次下载较小范围，第二次下载较大范围，验证去重增量下载功能
# 将16次下载的输出保存到指定目录的txt文件中
...
OUTPUT_DIR="/home/quan/testdata/aspipe_v4/p/interface4/type_b_output"
TS_CODE="000001.SZ"
...
# 主函数
main() {
    echo "开始测试 Type B 接口的增量下载功能"
    echo "=================================="
    echo "Type B 接口：报告期接口（支持范围查询）"
    echo "股票代码: $TS_CODE"
